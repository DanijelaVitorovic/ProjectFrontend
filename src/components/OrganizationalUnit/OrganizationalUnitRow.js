  ...
  render() {
    const row = (
      <tr>
        ...
        <td>{this.props.organizationalUnit.legalEntity.pib}</td>
        <td>{this.props.organizationalUnit.legalEntity.email}</td>
        <td>{this.props.organizationalUnit.legalEntity.statment}</td>
        ...
        <td className="text-center">
          <Badge pill variant="danger">
            <div
              onClick={() => this.onDeleteClick(this.props.organizationalUnit.id)}
            >
